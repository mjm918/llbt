...
#ifndef LLBT_AGGREGATE_OPS_HPP
#define LLBT_AGGREGATE_OPS_HPP
...
namespace llbt::aggregate_operations {
...
class Sum {
public:
    using ResultType = typename llbt::ColumnSumType<T>;
...
class Average {
public:
    using ResultType = typename std::conditional<llbt::is_any_v<T, Decimal128, Mixed>, Decimal128, double>::type;
    ...
    ResultType result() const
    {
        LLBT_ASSERT_EX(m_count > 0, m_count);
