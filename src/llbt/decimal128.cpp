...
void llbt_binary64_to_bid128(BID_UINT128* pres, double* px, _IDEC_flags* pfpsf)
{
    double x = *px;
    BID_UINT128 c;
...
{
    // The logic below is ported from the original Decimal128 implementation.
    uint64_t largest_coeff = (rounding_precision == RoundTo::Digits7) ? 9999999 : 999999999999999;
    unsigned flags = 0;
    BID_UINT128 converted_value;
    llbt_binary64_to_bid128(&converted_value, &val, &flags);
