...
#ifndef LLBT_ARRAY_DECIMAL128_HPP
#define LLBT_ARRAY_DECIMAL128_HPP
...
public:
    ...
    {
        return nullable ? Decimal128(llbt::null()) : Decimal128(0);
    }
    ...
    {
        LLBT_ASSERT(ndx < m_size);
        switch (m_width) {
            case 0:
                return get_context_flag() ? Decimal128() : Decimal128(llbt::null());
            case 4: {
...
#endif /* LLBT_ARRAY_DECIMAL128_HPP */
