...
#ifndef LLBT_ARRAY_INTEGER_TPL_HPP
#define LLBT_ARRAY_INTEGER_TPL_HPP
...
size_t ArrayIntNull::find_first(value_type value, size_t start, size_t end) const
{
    ...
    if (end - start == 1) {
        ...
        return c(opt_int, value, !opt_int, !value) ? start : llbt::not_found;
    }
...
#endif /* LLBT_ARRAY_INTEGER_TPL_HPP */
