...
#ifndef LLBT_DECIMAL_HPP
#define LLBT_DECIMAL_HPP
...
namespace std {
template <>
struct numeric_limits<llbt::Decimal128> {
    static constexpr bool is_integer = false;
    static llbt::Decimal128 lowest() noexcept
    {
        return llbt::Decimal128("-Inf");
    }
    static llbt::Decimal128 max() noexcept
    {
        return llbt::Decimal128("+Inf");
    }
};
