...
#define LLBT_IMPL_SIMULATED_FAILURE_HPP
...
#ifdef LLBT_DEBUG
#define LLBT_ENABLE_SIMULATED_FAILURE
#endif
...
public:
    ...
    /// type on the calling thread, but only if LLBT_ENABLE_SIMULATED_FAILURE
    /// was defined during compilation. If LLBT_ENABLE_SIMULATED_FAILURE was
    ...
    /// Returns true when, and only when LLBT_ENABLE_SIMULATED_FAILURE was
...
private:
#ifdef LLBT_ENABLE_SIMULATED_FAILURE
...
template <>
struct is_error_code_enum<llbt::_impl::SimulatedFailure::FailureType> {
...
#endif // LLBT_IMPL_SIMULATED_FAILURE_HPP
