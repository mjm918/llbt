...
#ifndef LLBT_IMPL_CONT_TRANSACT_HIST_HPP
#define LLBT_IMPL_CONT_TRANSACT_HIST_HPP

#include <cstdint>
#include <memory>

#include <llbt/column_binary.hpp>
...
public:
    ...
    /// history as part of versioned Barq state).
    ///
    ...
    /// except in the initial empty Barq state.
    ///
    ...
    /// of histories are stored inside the Barq file.
...
#endif // LLBT_IMPL_CONTINUOUS_TRANSACTIONS_HISTORY_HPP
