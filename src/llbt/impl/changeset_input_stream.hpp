...
#ifndef LLBT_IMPL_INPUT_STREAM_HPP
#define LLBT_IMPL_INPUT_STREAM_HPP
...
public:
    ...
    util::Span<const char> next_block() override
    {
        while (m_valid) {
            ...
            if (LLBT_UNLIKELY(m_changesets_begin == m_changesets_end)) {
                get_changeset();
            }
        }
...
#endif // LLBT_IMPL_INPUT_STREAM_HPP
