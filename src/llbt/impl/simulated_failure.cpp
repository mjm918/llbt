...
#include <llbt/util/basic_system_errors.hpp>
...
#if !defined(__clang__) || LLBT_HAVE_CLANG_FEATURE(cxx_thread_local)
thread_local
#endif
...
#endif // LLBT_ENABLE_SIMULATED_FAILURE
