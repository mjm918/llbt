...
#ifndef LLBT_OBJECT_ID_HPP
#define LLBT_OBJECT_ID_HPP
...
namespace std {
template <>
struct hash<llbt::ObjectId> {
    size_t operator()(const llbt::ObjectId& oid) const noexcept
    {
        return oid.hash();
    }
};
