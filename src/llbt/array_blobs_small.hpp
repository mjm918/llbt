...
#define LLBT_ARRAY_BLOBS_SMALL_HPP
...
{
    LLBT_ASSERT_3(ndx, <, m_offsets.size());
...
{
    LLBT_ASSERT_3(ndx, <, m_nulls.size());
...
{
    LLBT_ASSERT(new_size == 0 || new_size < m_offsets.size());
