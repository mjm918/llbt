...
#ifndef LLBT_ARRAY_BASIC_HPP
#define LLBT_ARRAY_BASIC_HPP
...
public:
    ...
    bool is_null(size_t ndx) const noexcept
    {
        ...
        static_assert(llbt::is_any<T, float, double>::value, "T can only be float or double");
...
#include <llbt/array_basic_tpl.hpp>

#endif // LLBT_ARRAY_BASIC_HPP
