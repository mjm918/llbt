...
#ifndef LLBT_UTILITIES_HPP
#define LLBT_UTILITIES_HPP
...
#define LLBT_X86_OR_X64
#define LLBT_X86_OR_X64_TRUE true
#else
#define LLBT_X86_OR_X64_TRUE false
#endif

// GCC defines __arm__
#ifdef __arm__
#define LLBT_ARCH_ARM
#endif
...
#if defined(LLBT_PTR_64) && defined(LLBT_X86_OR_X64) && !LLBT_WATCHOS
#define LLBT_COMPILER_SSE // Compiler supports SSE 4.2 through __builtin_ accessors or back-end assembler
#define LLBT_COMPILER_AVX
#endif
...
{
    LLBT_ASSERT_DEBUG(!util::int_cast_has_overflow<size_t>(v));
    return size_t(v);
}
...
// Use llbt::safe_equal() instead of std::equal() if one of the parameters can be a null pointer.
...
// Use llbt::safe_copy_n() instead of std::copy_n() if one of the parameters can be a null pointer. See the
