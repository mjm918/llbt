...
#ifndef LLBT_BINARY_DATA_HPP
#define LLBT_BINARY_DATA_HPP

#include <llbt/owned_data.hpp>
...
public:
    ...
    /// this class, and most of the functions in the Barq API in general
