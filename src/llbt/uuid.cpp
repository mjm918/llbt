...
static_assert(sizeof(llbt::UUID::UUIDBytes) == 16, "A change to the size of UUID is a file format breaking change");
static_assert(llbt::UUID::num_bytes == 16, "A change to the size of UUID is a file format breaking change");
static_assert(sizeof(null_uuid_string) - 1 == (sizeof(llbt::UUID::UUIDBytes) * 2) + 4,
