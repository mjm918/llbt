...
static const constexpr MapElem string_to_error_code[] = {
    ...
    {"BadJsonParse", ErrorCodes::BadJsonParse},
    ...
    {"ClosedBarq", ErrorCodes::ClosedBarq},
    ...
    {"DeleteOnOpenBarq", ErrorCodes::DeleteOnOpenBarq},
    ...
    {"ServiceError", ErrorCodes::ServiceError},
