...
#ifndef LLBT_EXCEPTIONS_HPP
#define LLBT_EXCEPTIONS_HPP

#include <llbt/status.hpp>
...
/// and/or a deprecated history schema which this version of Barq cannot
/// upgrade from.
...
/// exception is part of Barq's private API.
///
