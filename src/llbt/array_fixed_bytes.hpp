...
#ifndef LLBT_ARRAY_FIXED_BYTES_HPP
#define LLBT_ARRAY_FIXED_BYTES_HPP
...
public:
    ...
    {
        LLBT_ASSERT(is_valid_ndx(ndx));
        LLBT_ASSERT(!is_null(ndx));
...
#endif /* LLBT_ARRAY_FIXED_BYTES_HPP */
