...
#ifndef LLBT_DATA_TYPE_HPP
#define LLBT_DATA_TYPE_HPP
...
typedef llbt::StringData String;
typedef llbt::BinaryData Binary;
typedef llbt::Decimal128 Decimal;

struct ColumnType;

struct DataType {
    enum class Type {
        // Note: Value assignments must be kept in sync with <barq/column_type.h>
