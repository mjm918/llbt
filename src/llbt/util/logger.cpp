...
LogCategory LogCategory::barq("Barq", nullptr);
LogCategory LogCategory::storage("Storage", &barq);
...
LogCategory LogCategory::sync("Sync", &barq);
...
LogCategory LogCategory::app("App", &barq);
LogCategory LogCategory::sdk("SDK", &barq);
