...
#ifndef LLBT_UTIL_BACKTRACE_HPP
#define LLBT_UTIL_BACKTRACE_HPP
...
inline std::ostream& operator<<(std::ostream& os, const llbt::util::Backtrace& bt)
{
    bt.print(os);
    return os;
}

#endif // LLBT_UTIL_BACKTRACE_HPP
