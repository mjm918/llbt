...
#ifndef LLBT_UTIL_BASIC_SYSTEM_ERRORS_HPP
#define LLBT_UTIL_BASIC_SYSTEM_ERRORS_HPP

#include <cerrno>
#include <system_error>

namespace llbt::util::error {
...
template <>
class is_error_code_enum<llbt::util::error::basic_system_errors> {
public:
...
#endif // LLBT_UTIL_BASIC_SYSTEM_ERRORS_HPP
