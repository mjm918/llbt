...
#ifndef LLBT_UTIL_LOGGER_HPP
#define LLBT_UTIL_LOGGER_HPP
...
public:
    ...
    ///             output.
    // equivalent to llbt_log_level_e in barq.h and must be kept in sync -
    ...
    static LogCategory barq; // Top level category
...
protected:
    ...
    const LogCategory& m_category{LogCategory::barq};
...
private:
    template <class... Params>
    LLBT_NOINLINE void do_log(const LogCategory& category, Level, const char* message, Params&&...);
};
