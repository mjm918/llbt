...
#ifndef LLBT_UTIL_ENCRYPTED_FILE_MAPPING_HPP
#define LLBT_UTIL_ENCRYPTED_FILE_MAPPING_HPP
...
private:
    ...
    LLBT_NORETURN void throw_decryption_error(size_t ndx, std::string_view msg) REQUIRES(m_file.mutex);
...
#endif // LLBT_UTIL_ENCRYPTED_FILE_MAPPING_HPP
