...
#ifndef LLBT_UTIL_FILE_HPP
#define LLBT_UTIL_FILE_HPP
...
#include <filesystem>
#define LLBT_HAVE_STD_FILESYSTEM 1
#else
#define LLBT_HAVE_STD_FILESYSTEM 0
#endif

#if LLBT_APPLE_DEVICE && !LLBT_TVOS && !LLBT_MACCATALYST
#define LLBT_FILELOCK_EMULATION
#endif
