...
#ifndef LLBT_UTIL_TIMESTAMP_FORMATTER_HPP
#define LLBT_UTIL_TIMESTAMP_FORMATTER_HPP
...
inline auto TimestampFormatter::format(std::chrono::time_point<B> time) -> string_view_type
{
    ...
    LLBT_ASSERT(nanoseconds >= 0 && nanoseconds < 1000000000);
...
#endif // LLBT_UTIL_TIMESTAMP_FORMATTER_HPP
