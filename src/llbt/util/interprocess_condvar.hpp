...
#ifndef LLBT_UTIL_INTERPROCESS_CONDVAR
#define LLBT_UTIL_INTERPROCESS_CONDVAR
...
/// for the inter-process case, if enabled by LLBT_CONDVAR_EMULATION.
///
...
private:
    ...
    struct HandleHolder {
        ...
        {
            if (handle)
                LLBT_ASSERT_RELEASE(CloseHandle(handle));
        }
