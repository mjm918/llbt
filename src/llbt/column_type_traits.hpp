...
#ifndef LLBT_COLUMN_TYPE_TRAITS_HPP
#define LLBT_COLUMN_TYPE_TRAITS_HPP
...
struct ObjectTypeTraits {
    constexpr static bool self_contained_null =
        llbt::is_any_v<T, StringData, BinaryData, Decimal128, Timestamp, Mixed>;
};
...
#endif // LLBT_COLUMN_TYPE_TRAITS_HPP
