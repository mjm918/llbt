...
#ifndef LLBT_NMMINTRIN_H
#define LLBT_NMMINTRIN_H

/*
    We must support runtime detection of CPU support of SSE when distributing Barq as a closed source library.
...
#if !defined(_MSC_VER) && defined(LLBT_COMPILER_SSE)
...
#endif // !defined(_MSC_VER) && defined(LLBT_COMPILER_SSE)
#endif
