...
TEST(ArrayString_Null)
{
...

    {
        ...
        // Test insert
        a.insert(0, llbt::null());
        a.insert(2, llbt::null());
        a.insert(4, llbt::null());
    ...
    for (size_t t = 0; t < 50; t++) {
        ...
        for (size_t i = 0; i < 100; i++) {
            ...
            if (rnd < 80 && a.size() > 0) {
                ...
                // Generate string with good probability of being empty or llbt::null()
                static const char str[] = "This is a test of llbt::null() strings";
                size_t len;
