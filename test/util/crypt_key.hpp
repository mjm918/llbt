...
#ifndef LLBT_TEST_UTIL_CRYPT_KEY_HPP
#define LLBT_TEST_UTIL_CRYPT_KEY_HPP
...
/// (LLBT_ENABLE_ENCRYPTION), and either \a always is true or global mode
...
#endif // LLBT_TEST_UTIL_CRYPT_KEY_HPP
