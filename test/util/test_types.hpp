...
#ifndef LLBT_TEST_UTIL_TEST_TYPES_HPP
#define LLBT_TEST_UTIL_TEST_TYPES_HPP
...
#define TEST_TYPES_IF(name, enabled, ...)                                                                            \
    TEST_TYPES_EX(name, llbt::test_util::unit_test::get_default_test_list(), enabled, true, __VA_ARGS__)
...
#define NONCONCURRENT_TEST_TYPES_IF(name, enabled, ...)                                                              \
    TEST_TYPES_EX(name, llbt::test_util::unit_test::get_default_test_list(), enabled, false, __VA_ARGS__)
...
#define TEST_TYPES_EX(name, list, enabled, allow_concur, ...)                                                        \
    ...
    llbt::test_util::unit_test::RegisterTypeTests<Barq_UnitTest__##name, __VA_ARGS__> llbt_unit_test_reg__##name( \
        (list), (allow_concur), "DefaultSuite", #name, __FILE__, __LINE__);                                          \
    template <class TEST_TYPE>                                                                                       \
    void Barq_UnitTest__##name<TEST_TYPE>::test_run()
...
#endif // LLBT_TEST_UTIL_TEST_TYPES_HPP
