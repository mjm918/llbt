...
#ifndef LLBT_TEST_UTIL_SPAWNED_PROCESS_HPP
#define LLBT_TEST_UTIL_SPAWNED_PROCESS_HPP
...
// a child process via the LLBT_CHILD_IDENT environment variable, then no process is actually started here.
...
#endif // LLBT_TEST_UTIL_SPAWNED_PROCESS_HPP
