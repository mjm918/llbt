...
#ifndef LLBT_TEST_UTIL_TEST_PATH_HPP
#define LLBT_TEST_UTIL_TEST_PATH_HPP
...
#define TEST_PATH_HELPER(class_name, var_name, suffix)                                                               \
    class_name var_name(llbt::test_util::get_test_path(test_context.get_test_name(), "." #var_name "." suffix))

#if LLBT_PLATFORM_APPLE
// Apple doesn't support file names with "�"
#define TEST_PATH(var_name) TEST_PATH_HELPER(llbt::test_util::TestPathGuard, var_name, "test");
#else
#define TEST_PATH(var_name) TEST_PATH_HELPER(llbt::test_util::TestPathGuard, var_name, "tempor�re");
#endif

#define TEST_DIR(var_name) TEST_PATH_HELPER(llbt::test_util::TestDirGuard, var_name, "test-dir");

#define GROUP_TEST_PATH(var_name) TEST_PATH_HELPER(llbt::test_util::TestPathGuard, var_name, "barq");

#define SHARED_GROUP_TEST_PATH(var_name) TEST_PATH_HELPER(llbt::test_util::DBTestPathGuard, var_name, "barq");
...
// BarqPathInfo test_context { path };
struct BarqPathInfo {
    std::string m_path;
...
#endif // LLBT_TEST_UTIL_TEST_PATH_HPP
