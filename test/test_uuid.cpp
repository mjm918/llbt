...
#include <chrono>
#include <llbt/array_fixed_bytes.hpp>
...
// with credit to the upstream UUID tests this was derived from.
TEST(UUID_isValid)
{
...
// when using LLBT_MAX_BPNODE_SIZE = 4
